  ...
  return (
    <div className="flex flex-col pt-36">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto text-center md:px-6 px-4 space-y-6">
          <Badge variant="outline" className="bg-green-100 text-green-600 text-md">
            Split expenses, Simplify life.
          </Badge>
        
          <h1 className="gradient-title mx-auto text-4xl max-w-4xl font-bold md:text-7xl">
        ...
        <div className='container mx-auto max-w-5xl overflow-hidden rounded-xl '>
          <div className=' gradientarpit p-1 aspect-[16/9]'>
            <Image 
            src={"/hero/create image where bee is handling the money expenses.jpg"}
            alt="SplitBee Logo"
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map(({ title, Icon, bg, color, description }) => (
              ...
              >
                ...
                {/* ───── Features ───── */}
                {/* same as the features jut bit of smoe css changes */}
      ...
      <footer className="border-t bg-gray-50 py-12 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} SplitBee 🐝 . All rights reserved.
      </footer>
    </div>
  );
}
