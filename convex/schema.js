...
export default defineSchema({
  ...
  expenses: defineTable({
    ...
    .index("by_group", ["groupId"])//only those expenses which bellong to a group
    .index("by_user_and_group", ["paidByUserId", "groupId"]) // Expenses paid by a user in a group
    .index("by_date", ["date"]), // Index for expenses by date
